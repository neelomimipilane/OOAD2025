    ...
    private void updateAccountDetails() {
        ...
        if (selected != null) {
            ...
            if (selected instanceof SavingsAccount) {
                ...
                accountTypeLabel.setText("Account Type: Savings Account (" + savings.getInterestRatePercentage() + " interest - " + customerType + ")");
                ...
                String customerType = (currentCustomer instanceof CustomerBusiness) ? "Business" : "Individual";
                accountTypeLabel.setText("Account Type: Investment Account (" + investment.getInterestRatePercentage() + " interest - " + customerType + ")");
