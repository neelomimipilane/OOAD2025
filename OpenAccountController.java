...
public class OpenAccountController {
    ...
    private Label createInfoLabel(String text) {
        ...
        label.setStyle("-fx-text-fill: rgba(26,244,244,0.66); -fx-font-size: 11; -fx-wrap-text: true;");
    ...
    private void handleCreateAccount() {
        try {
            ...
            switch (accountType) {
                case "Savings Account":
                    typeForMain = "Savings";
                    success = Main.createAccount(customer, typeForMain, accountNumber, "", "", 0);
                    if (success) {
                ...
                case "Cheque Account":
                    ...
                    success = Main.createAccount(customer, typeForMain, accountNumber, empName, empAddress, 0);
                    if (success) {
                ...
                case "Investment Account":
                    typeForMain = "Investment";
                    double initialDeposit = Double.parseDouble(initialDepositField.getText().trim());
                    success = Main.createAccount(customer, typeForMain, accountNumber, "", "", initialDeposit);
                    break;
            }
